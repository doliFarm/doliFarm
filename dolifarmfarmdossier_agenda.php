...
/**
 *  \file       dolifarmfarmdossier_agenda.php
 *  \ingroup    dolifarm
 *  \brief      Tab of events on DoliFarmFarmDossier
 */
...
if ($object->id > 0) {
	$title = $langs->trans("DoliFarmFarmDossier")." - ".$langs->trans('Agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("DoliFarmFarmDossier"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_dolifarmfarmdossier_'.$object->id;
