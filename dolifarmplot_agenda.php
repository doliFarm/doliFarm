...
/**
 *  \file       dolifarmplot_agenda.php
 *  \ingroup    dolifarm
 *  \brief      Tab of events on DoliFarmPlot
 */
...
if ($object->id > 0) {
	$title = $langs->trans("DoliFarmPlot")." - ".$langs->trans('Agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("DoliFarmPlot"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_dolifarmplot_'.$object->id;
