...
/**
 *   	\file       dolifarmestimatecosts_list.php
 *		\ingroup    dolifarm
 *		\brief      List page for dolifarmestimatecosts
 */
...
include_once __DIR__.'/class/dolifarmestimatecosts.class.php';
// for other modules
...
if ($enablepermissioncheck) {
	...
	$permissiontoadd = $user->hasRight('dolifarm', 'dolifarmestimatecosts', 'write');
	$permissiontodelete = $user->hasRight('dolifarm', 'dolifarmestimatecosts', 'delete');
} else {
	$permissiontoread = 1;
	$permissiontoadd = 1;
...
if (empty($reshook)) {
	...
	// Mass actions
	$objectclass = 'DoliFarmEstimateCosts';
	$objectlabel = 'DoliFarmEstimateCosts';
...
$title = $langs->trans("DoliFarmEstimateCostss");
//$help_url = "EN:Module_DoliFarmEstimateCosts|FR:Module_DoliFarmEstimateCosts_FR|ES:Módulo_DoliFarmEstimateCosts";
$help_url = '';
$morejs = array();
$morecss = array();
...
if ($num == 1 && getDolGlobalInt('MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE') && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/dolifarm/dolifarmestimatecosts_card.php', 1).'?id='.((int) $id));
	exit;
}
...
$newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/dolifarm/dolifarmestimatecosts_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, $object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendDoliFarmEstimateCostsRef";
$modelmail = "dolifarmestimatecosts";
$objecttmp = new DoliFarmEstimateCosts($db);
