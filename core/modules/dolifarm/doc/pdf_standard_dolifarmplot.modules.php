...
/**
 *	Class to manage PDF template standard_dolifarmplot
 */
class pdf_standard_dolifarmplot extends ModelePDFDoliFarmPlot
{
	/**
	 ...
	 *
	 *	@param	TCPDF|TCPDI	$pdf     		Object PDF
	 *	@param	DoliFarmPlot	$object     	Object to show
