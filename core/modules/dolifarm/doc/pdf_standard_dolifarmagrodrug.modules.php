...
/**
 *	Class to manage PDF template standard_dolifarmagrodrug
 */
class pdf_standard_dolifarmagrodrug extends ModelePDFDoliFarmAgroDrug
{
	/**
	 ...
	 *
	 *	@param	TCPDF|TCPDI	$pdf     		Object PDF
	 *	@param	DoliFarmAgroDrug	$object     	Object to show
