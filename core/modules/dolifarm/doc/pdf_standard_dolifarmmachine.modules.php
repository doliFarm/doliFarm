...
/**
 *	Class to manage PDF template standard_dolifarmmachine
 */
class pdf_standard_dolifarmmachine extends ModelePDFDoliFarmMachine
{
	/**
	 ...
	 *
	 *	@param	TCPDF|TCPDI	$pdf     		Object PDF
	 *	@param	DoliFarmMachine	$object     	Object to show
