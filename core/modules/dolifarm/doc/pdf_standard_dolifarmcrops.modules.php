...
/**
 *	Class to manage PDF template standard_dolifarmcrops
 */
class pdf_standard_dolifarmcrops extends ModelePDFDoliFarmCrops
{
	/**
	 ...
	 *
	 *	@param	TCPDF|TCPDI	$pdf     		Object PDF
	 *	@param	DoliFarmCrops	$object     	Object to show
