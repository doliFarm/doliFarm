...
/**
 *  \file       core/modules/dolifarm/doc/pdf_standard.modules.php
 *  \ingroup    dolifarm
...
/**
 *	Class to manage PDF template standard_dolifarmestimatecosts
 */
class pdf_standard_dolifarmestimatecosts extends ModelePDFDoliFarmEstimateCosts
{
	/**
	 ...
	 *
	 *	@param	TCPDF|TCPDI	$pdf     		Object PDF
	 *	@param	DoliFarmEstimateCosts	$object     	Object to show
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		// Show Draft Watermark
		if (getDolGlobalString('DOLIFARM_DRAFT_WATERMARK') && $object->status == $object::STATUS_DRAFT) {
			pdf_watermark($pdf, $outputlangs, $this->page_hauteur, $this->page_largeur, 'mm', dol_escape_htmltag(getDolGlobalString('DOLIFARM_DRAFT_WATERMARK')));
		}
