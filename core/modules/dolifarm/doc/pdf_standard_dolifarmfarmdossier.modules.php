...
/**
 *	Class to manage PDF template standard_dolifarmfarmdossier
 */
class pdf_standard_dolifarmfarmdossier extends ModelePDFDoliFarmFarmDossier
{
	/**
	 ...
	 *
	 *	@param	TCPDF|TCPDI	$pdf     		Object PDF
	 *	@param	DoliFarmFarmDossier	$object     	Object to show
