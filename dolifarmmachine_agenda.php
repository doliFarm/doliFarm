...
/**
 *  \file       dolifarmmachine_agenda.php
 *  \ingroup    dolifarm
 *  \brief      Tab of events on DoliFarmMachine
 */
...
if ($object->id > 0) {
	$title = $langs->trans("DoliFarmMachine")." - ".$langs->trans('Agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("DoliFarmMachine"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_dolifarmmachine_'.$object->id;
