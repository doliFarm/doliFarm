...
/**
 *       \file       htdocs/dolifarm/ajax/dolifarmagrodrug.php
 *       \brief      File to return Ajax response on dolifarmagrodrug list request
 */
...
// Security check
if (!$user->hasRight('dolifarm', 'dolifarmagrodrug', 'write')) {
	accessforbidden();
}
...
dol_syslog("Call ajax dolifarm/ajax/dolifarmagrodrug.php");
