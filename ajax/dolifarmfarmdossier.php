...
/**
 *       \file       htdocs/dolifarm/ajax/dolifarmfarmdossier.php
 *       \brief      File to return Ajax response on dolifarmfarmdossier list request
 */
...
// Security check
if (!$user->hasRight('dolifarm', 'dolifarmfarmdossier', 'write')) {
	accessforbidden();
}
...
dol_syslog("Call ajax dolifarm/ajax/dolifarmfarmdossier.php");
