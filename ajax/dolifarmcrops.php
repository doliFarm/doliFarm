...
/**
 *       \file       htdocs/dolifarm/ajax/dolifarmcrops.php
 *       \brief      File to return Ajax response on dolifarmcrops list request
 */
...
// Security check
if (!$user->hasRight('dolifarm', 'dolifarmcrops', 'write')) {
	accessforbidden();
}
...
dol_syslog("Call ajax dolifarm/ajax/dolifarmcrops.php");
