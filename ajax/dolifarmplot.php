...
/**
 *       \file       htdocs/dolifarm/ajax/dolifarmplot.php
 *       \brief      File to return Ajax response on dolifarmplot list request
 */
...
// Security check
if (!$user->hasRight('dolifarm', 'dolifarmplot', 'write')) {
	accessforbidden();
}
...
dol_syslog("Call ajax dolifarm/ajax/dolifarmplot.php");
