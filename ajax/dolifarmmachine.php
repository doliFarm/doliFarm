...
/**
 *       \file       htdocs/dolifarm/ajax/dolifarmmachine.php
 *       \brief      File to return Ajax response on dolifarmmachine list request
 */
...
// Security check
if (!$user->hasRight('dolifarm', 'dolifarmmachine', 'write')) {
	accessforbidden();
}
...
dol_syslog("Call ajax dolifarm/ajax/dolifarmmachine.php");
